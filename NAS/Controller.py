...
class Controller:
    ...
    def create_action_dict(self):
        """
        Creating a dictionary wih all possible actions based on the attributes in the action class
        :return dict {action number:attribute name}"""
        dictionary = dict()
    ...
    def get_model(self):
        """:return a neural network generated by the generator with values specified in the class"""
